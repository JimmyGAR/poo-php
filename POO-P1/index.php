...
class Encounter
{
    ...
    {
        return 1 / (1 + (10 ** (($againstPlayerTwo->getLevel() - $PlayerOne->getLevel()) / 400)));
    }
    ...
    public static function setNewLevel(Player $PlayerOne, Player $againstPlayerTwo, int $playerOneResult)
    {
        ...
        $PlayerOne->setLevel($PlayerOne->getLevel() + (int) (32 * ($playerOneResult - self::probabilityAgainst($PlayerOne, $againstPlayerTwo))));
    }
}
